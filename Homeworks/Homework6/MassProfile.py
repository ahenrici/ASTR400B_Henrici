...
Date Creaated:  2/13/2018
Date last modified: 2/13/2018
Description:  Calculate and plot the mass profile and
rotation curves for each galaxy at time snap 000
'''
...
class MassProfile:
    ...
    def __init__(self, galaxy, snap):
        ...
        # Store the velocities of only the particles of the given type
